...
For performance and layout reasons, the size of widgets in Notely is independent from its children. At CSS level, this means that the widget container has `contain: size` applied to it.
