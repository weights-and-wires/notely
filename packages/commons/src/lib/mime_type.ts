...
const MIME_TYPES_DICT_RAW = [
    ...
    { title: "JavaScript (Notely backend)", mime: "application/javascript;env=backend", mdLanguageCode: "javascript", default: true, icon: "bx bxl-javascript" },
    { title: "JavaScript (Notely frontend)", mime: "application/javascript;env=frontend", mdLanguageCode: "javascript", default: true, icon: "bx bxl-javascript" },
